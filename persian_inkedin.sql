...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2018 at 11:17 PM
...
--
-- Dumping data for table `plnk_avatar`
--

INSERT INTO `plnk_avatar` (`id`, `user_id`, `filename`, `time`, `status`, `user_agent`) VALUES
(1, 2, 'default.png', 1542357191, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 / IP: ::1');
...
--
-- Table structure for table `plnk_captcha`
--

CREATE TABLE `plnk_captcha` (
  `captcha_id` bigint(13) UNSIGNED NOT NULL,
  `captcha_time` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `plnk_city`
--

CREATE TABLE `plnk_city` (
  `id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `plnk_city`
--

INSERT INTO `plnk_city` (`id`, `country_id`, `name`, `status`) VALUES
(1, 1, 'تهران', 1),
(2, 1, 'اصفهان', 1),
(3, 2, 'کابل', 1);
...
CREATE TABLE `plnk_connections` (
  `id` bigint(20) NOT NULL,
  `user_requester_id` bigint(20) NOT NULL,
  `user_responder_id` bigint(20) NOT NULL,
  `time` bigint(20) NOT NULL,
  `status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
--
-- Dumping data for table `plnk_login`
--

INSERT INTO `plnk_login` (`id`, `user_id`, `time`, `user_agent`) VALUES
(1, 2, 1542357196, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 / IP: ::1'),
(2, 2, 1542357437, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 / IP: ::1'),
(3, 2, 1542388390, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 / IP: ::1'),
(4, 2, 1542401315, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 / IP: ::1');
...
--
-- Table structure for table `plnk_option`
--

CREATE TABLE `plnk_option` (
  `id` bigint(20) NOT NULL,
  `name` varchar(100) COLLATE utf8_persian_ci NOT NULL,
...
--
-- Dumping data for table `plnk_option`
--

INSERT INTO `plnk_option` (`id`, `name`, `value`) VALUES
(1, 'temp_lock', 'false');

-- --------------------------------------------------------

--
-- Table structure for table `plnk_page`
--

CREATE TABLE `plnk_page` (
  `id` bigint(20) NOT NULL,
  `name` varchar(100) COLLATE utf8_persian_ci NOT NULL,
...
CREATE TABLE `plnk_person` (
  ...
  `zip_code` varchar(20) COLLATE utf8_persian_ci NOT NULL,
  `birthday` varchar(10) COLLATE utf8_persian_ci NOT NULL,
  `biography` varchar(255) COLLATE utf8_persian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;

--
-- Dumping data for table `plnk_person`
--

INSERT INTO `plnk_person` (`id`, `user_id`, `firstname`, `lastname`, `country_id`, `city_id`, `zip_code`, `birthday`, `biography`) VALUES
(1, 2, 'امیر', 'شکری', NULL, NULL, '', '', '');
...
(2, 'amirsh.nll@outlook.com', '0d0540ee4361aae3d0786834fd59f2ad5a388885', 1542357190, 2, 1);
...
--
-- Dumping data for table `plnk_user_option`
--

INSERT INTO `plnk_user_option` (`id`, `user_id`, `name`, `value`) VALUES
(1, 2, 'private_page', 'true'),
(2, 2, 'private_contact', 'true'),
(3, 2, 'private_avatar', 'false'),
(4, 2, 'need_change_password', 'false');
...
--
-- Indexes for table `plnk_captcha`
--
ALTER TABLE `plnk_captcha`
  ADD PRIMARY KEY (`captcha_id`),
  ADD KEY `word` (`word`);

--
-- Indexes for table `plnk_city`
--
ALTER TABLE `plnk_city`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `plnk_connections`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_requester_id` (`user_requester_id`),
  ADD KEY `user_responder_id` (`user_responder_id`);
...
--
-- Indexes for table `plnk_option`
--
ALTER TABLE `plnk_option`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `plnk_page`
--
ALTER TABLE `plnk_page`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `plnk_captcha`
--
ALTER TABLE `plnk_captcha`
  MODIFY `captcha_id` bigint(13) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `plnk_city`
--
ALTER TABLE `plnk_city`
...
--
-- AUTO_INCREMENT for table `plnk_option`
--
ALTER TABLE `plnk_option`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `plnk_page`
--
ALTER TABLE `plnk_page`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `plnk_city`
--
ALTER TABLE `plnk_city`
  ADD CONSTRAINT `plnk_city_ibfk_1` FOREIGN KEY (`country_id`) REFERENCES `plnk_country` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `plnk_connections`
--
ALTER TABLE `plnk_connections`
  ADD CONSTRAINT `plnk_connections_ibfk_1` FOREIGN KEY (`user_requester_id`) REFERENCES `plnk_user` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `plnk_connections_ibfk_2` FOREIGN KEY (`user_responder_id`) REFERENCES `plnk_user` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
ALTER TABLE `plnk_person`
  ...
  ADD CONSTRAINT `plnk_person_ibfk_3` FOREIGN KEY (`city_id`) REFERENCES `plnk_city` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

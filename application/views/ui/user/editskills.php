				...
				<div class="row right-to-left text-right">
					<div class="col-md-9">
						<div class="content-box">
							<h5><span class="fas fa-1x fa-screwdriver"></span>&nbsp;<span>ویرایش مهارت ها </span></h5>
							<div class="real-content">
								{form_addskills_open}
									<p><span class="fas fa-1x fa-edit"></span>&nbsp;<strong>مهارت ها </strong></p>
									<p><span class="fas fa-1x fa-plus-square"></span>&nbsp;<span>افزودن مهارت ها  جدید</span></p>
									<p>{title_input}</p>
									<p>{content_input}</p>
								...
								<p>&nbsp;</p><p>&nbsp;</p>
								<p><span class="fas fa-1x fa-database"></span>&nbsp;<span>فهرست مهارت ها</span></p>

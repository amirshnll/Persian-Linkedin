					...
					<div class="col-md-9">
						<div class="content-box">
							...
							<div class="real-content">
								{form_editeducation_open}
									<p><span class="fas fa-1x fa-edit"></span>&nbsp;<strong>مدارک تحصیلی</strong></p>
									<p><span class="fas fa-1x fa-pen"></span>&nbsp;<span>ویرایش مدارک تحصیلی</span></p>
									<p>{id_input}</p>
									<p>{title_input}</p>
									<p>{content_input}</p>
									...
									<div class="float-left">
										<a href="{base}panel/profile/edit/education" title="بازگشت به پروفایل من"><span class="btn btn-danger text-light">بازگشت</span></a>
										{submit_input}
									</div>

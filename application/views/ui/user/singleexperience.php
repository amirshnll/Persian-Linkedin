				...
				<div class="row right-to-left text-right">
					<div class="col-md-9">
						<div class="content-box">
							<h5>ویرایش موقعیت های شغلی </h5>
							<div class="real-content">
								{form_editexperience_open}
									<p><strong>موقعیت های شغلی </strong></p>
									...
									<div class="float-left">
										<a href="{base}panel/profile/edit/experience" title="بازگشت به پروفایل من"><span class="btn btn-danger text-light">بازگشت</span></a>
										{submit_input}
									</div>

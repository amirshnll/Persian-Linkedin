					...
					<div class="col-md-3 left-to-right">
						<nav class="navbar">
							<ul class="nav">
								...
								<a href="{base}panel" title="تنظیمات"><li><span class="fas fa-lg fa-cog"></span></li></a>
								<a href="{base}panel" title="پروفایل من"><li><span class="fas fa-lg fa-user"></span></li></a>
								<a href="{base}panel" title="اعلانات"><li><span class="fas fa-lg fa-bell"></span></li></a>
								<a href="{base}panel" title="پیام ها"><li><span class="fas fa-lg fa-envelope"></span></li></a>
							</ul>
						</nav>
					</div>
				</div>
				...
				<div class="row right-to-left text-right">
					<div class="col-md-3">
						<div class="content-box">
							<h5>شاید این افراد را بشناسید</h2>
						</div>
					</div>
					<div class="col-md-6">
						<div class="content-box">

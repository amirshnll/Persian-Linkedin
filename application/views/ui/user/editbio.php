...
<head>
	...
	<title>لینکدین فارسی - ویرایش بیوگرافی</title>
				...
				<div class="row right-to-left text-right">
					<div class="col-md-9">
						<div class="content-box">
							<h5><span class="fas fa-1x fa-monument"></span>&nbsp;<span>ویرایش بیوگرافی</span></h5>
							<div class="real-content">
								{form_editbio_open}
									<p><span class="fas fa-1x fa-edit"></span>&nbsp;<strong>ویرایش بیوگرافی</strong></p>
									{bio_input}
									<p>&nbsp;</p>
								...
								<p>بیوگرافی در شناسایی و معرفی شما امتیاز ویژه ای خواهد داشت.</p>
							</div>
						</div>
					</div>
					<div class="col-md-3">

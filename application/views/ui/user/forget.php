						...
						<div class="form form-group">
							{form_open}
								...
								<div class="text-center">
									...
									<div class="float-right d-inline width-50"><a href="{base}login" title="بازگشت به صفحه ورود" class="nav-link text-light"><span>انصراف</span>&nbsp;<span class="fas fa-1x fa-ban"></span></a></div>

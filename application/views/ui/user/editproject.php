						...
						<div class="content-box">
							...
							<div class="real-content">
								...
								<table border="1" class="database-table">
									...
									<tbody>
										<?php
											if($user_project !== false)
											{
												$counter = 1;
												foreach ($user_project as $ux) {
													echo '<tr>';
													echo '<td>' . $counter . '</td>';
													echo '<td>' . $ux['title'] . '</td>';
													...
													echo '<td class="text-center"><a href="{base}panel/profile/edit/project/edit/' . $ux['id'] . '" title="ویرایش" class="text-warning"><span class="fas fa-1x fa-edit"></span></a> <a href="{base}panel/profile/edit/project/delete/' . $ux['id'] . '" title="حذف" class="text-danger"><span class="fas fa-1x fa-trash"></span></a></td>';
													echo '</tr>';
													$counter+=1;
												}
											}
